 ...
 * Canonical set (P09b / migration 0025 / issue #119; extended M3 / migration 0031). Lockstep across:
 *
 *   - This TS union (canonical source of truth)
 *   - DB CHECK: pipeline_events_stage_check (migration 0025, extended in 0031)
 *
 ...
 *     extract_commitments (commitment extraction, added M3/0031),
